...
class GeminiSessionCost(models.Model):
    ...
    input_text_tokens = models.IntegerField(default=0, help_text="Number of input text tokens (system prompt + conversation text)")
    input_audio_tokens = models.IntegerField(default=0, help_text="Number of input audio tokens (user speech)")
    output_text_tokens = models.IntegerField(default=0, help_text="Number of output text tokens (model text/thinking)")
